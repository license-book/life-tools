...
export const metadata:Metadata={title:"WORK 생활도구 | 월급·주급·퇴직금·연봉·수당·연차 계산기",description:"급여 실수령액, 주급, 퇴직금, 연봉·시급 환산, 2026 최저임금, 연장근로수당, 주휴수당, 연차수당, 근무시간과 업무일 계산 도구를 모았습니다.",alternates:{canonical:"/work"}};

const employeeCoreSlugs=["salary-net-calculator","weekly-pay","severance-pay","annual-salary","wage-converter","minimum-wage-monthly","salary-raise","overtime-pay","weekly-holiday-pay","annual-leave-pay","annual-leave-balance","tenure-duration"];
