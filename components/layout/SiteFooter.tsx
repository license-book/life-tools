...
export default function SiteFooter(){
  return <footer className="site-footer">
    <div className="container site-footer-grid">
      ...
      <div className="site-footer-column"><strong>생활도구</strong><Link href="/tools">전체 도구</Link><Link href="/money">돈·금융</Link><Link href="/home">집·주거</Link><Link href="/car">자동차</Link><Link href="/buy">쇼핑</Link><Link href="/work">직장·업무</Link><Link href="/life">일상·생활</Link></div>
      <div className="site-footer-column"><strong>안내</strong><Link href="/about">서비스 소개</Link><Link href="/privacy">개인정보처리방침</Link><Link href="/terms">이용약관</Link><Link href="/contact">문의</Link><Link href="/sitemap.html">사이트맵</Link></div>
    </div>
