...
export default function HomePage() {
  ...
  const readyTools = [...moneyTools,...homeTools,...carTools];
    ...
    <>
      ...
      <main>
        ...
        <section className="section">
          <div className="container">
            <h2>지금 바로 쓸 수 있는 생활도구 {readyTools.length}개</h2>
            <p className="section-intro">MONEY·HOME·CAR 핵심 도구를 먼저 제공합니다. 자주 쓰는 계산부터 바로 시작하세요.</p>
            <div className="grid">
              {[...moneyTools.slice(0,2),...homeTools.slice(0,2),...carTools.slice(0,2)].map((tool) => (
        ...
        <section className="section">
          <div className="container">
            ...
            <p className="section-intro">MONEY·HOME·CAR부터 공개하고 BUY·WORK·LIFE로 계속 확장합니다.</p>
            <div className="grid">
