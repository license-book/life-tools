...
export default function LifePage() {
  ...
  return <><SiteHeader/><main>
    <section className="hero"><div className="container"><span className="eyebrow">LIFE · 일상과 생활</span><h1>시간·일정·여행까지 일상 계산을 한곳에서</h1><p>날짜와 시간 계산부터 수면 일정, 여행 준비와 경비, 수하물 무게, 기념일, 걷기·달리기 페이스까지 반복해서 확인하는 생활 정보를 빠르게 계산하고 정리하세요.</p><div className="trust-row"><span className="trust-chip">✓ 무료</span><span className="trust-chip">✓ 회원가입 없음</span><span className="trust-chip">✓ 즉시 계산</span><span className="trust-chip">✓ 인쇄·PDF 저장</span></div></div></section>
