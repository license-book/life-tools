...
export default function ToolPageRenderer({ tool, calculator }: ToolPageRendererProps) {
  ...
  return <>
    ...
    <main>
      ...
      <section className="section"><div className="container"><div><h2>{tool.calculatorTitle}</h2><p className="section-intro">{tool.calculatorDescription}</p></div><div className="no-print" style={{display:"flex",justifyContent:"flex-end",margin:"-8px 0 14px"}}><ToolResetButton /></div>{calculator}<ToolOutputActions /></div></section>
